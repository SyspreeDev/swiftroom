...
const images = [
  { src: "/images/img1.jpg", title: "CONTEMPORARY VILLA", desc: "Premium aluminum windows and doors" },
  { src: "/images/img2.jpg", title: "SMART LIVING", desc: "Future-ready systems" },
  { src: "/images/img3.jpg", title: "MODERN HOME", desc: "Elegant glass solutions" },
  { src: "/images/img1.jpg", title: "CONTEMPORARY VILLA", desc: "Premium aluminum windows and doors" },
  { src: "/images/img2.jpg", title: "SMART LIVING", desc: "Future-ready systems" },
  { src: "/images/img3.jpg", title: "MODERN HOME", desc: "Elegant glass solutions" },
];
...
export default function SliderGallery() {
  return (
    <section id="gallery" className="relative pt-10 pb-16 md:pt-20 md:pb-28 bg-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="prev-btn absolute left-4 md:left-24 top-1/2 -translate-y-1/2 z-50 w-[64px] h-[64px] flex items-center justify-center cursor-pointer group">
          ...
          <div className="w-[56px] h-[56px] rounded-full bg-white flex items-center justify-center relative shadow-sm">
            ...
            <div className="relative flex items-center justify-center text-[#0B7D69]">
              ...
              <FaChevronLeft size={20} className="absolute opacity-0 translate-x-2 group-hover:translate-x-[6px] group-hover:opacity-60 transition-all duration-300" />
              {/* Main chevron that pushes forward */}
              <FaChevronLeft size={20} className="relative group-hover:-translate-x-[4px] transition-all duration-300" />
            </div>
          </div>
        </div>
        ...
        <div className="next-btn absolute right-4 md:right-24 top-1/2 -translate-y-1/2 z-50 w-[64px] h-[64px] flex items-center justify-center cursor-pointer group">
          ...
          <div className="w-[56px] h-[56px] rounded-full bg-white flex items-center justify-center relative shadow-sm">
            ...
            <div className="relative flex items-center justify-center text-[#0B7D69]">
              {/* Ghost chevron that slides in from behind */}
              <FaChevronRight size={20} className="absolute opacity-0 -translate-x-2 group-hover:-translate-x-[6px] group-hover:opacity-60 transition-all duration-300" />
              {/* Main chevron that pushes forward */}
              <FaChevronRight size={20} className="relative group-hover:translate-x-[4px] transition-all duration-300" />
            </div>
          </div>
        </div>
                  ...
                  {isActive && (
                    <div className="absolute bottom-6 left-0 right-0 flex justify-center pointer-events-none">
                      <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full">
                        ...
                        <span className="text-gray-800 font-semibold text-sm tracking-wider">SWIFTROOMS</span>
                      </div>
                    </div>
                  )}
                </Tilt>
